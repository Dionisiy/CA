...
**Inline styles** are CSS declarations that affect one element only, contained within a [`style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style)attribute:
